...
export class OdontogramaService {
  ...
  async findByPacienteId(pacienteId: number): Promise<Odontograma | null> {
    return await this.odontogramaRepository.findOne({
